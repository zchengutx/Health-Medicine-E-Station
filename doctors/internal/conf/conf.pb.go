...
type Data struct {
	...
	AliYun        *Data_AliYun           `protobuf:"bytes,3,opt,name=ali_yun,json=aliYun,proto3" json:"ali_yun,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetAliYun() *Data_AliYun {
	if x != nil {
		return x.AliYun
	}
	return nil
...
func (x *Data_AliYun) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_AliYun) ProtoMessage() {}

func (x *Data_AliYun) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_AliYun.ProtoReflect.Descriptor instead.
func (*Data_AliYun) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_AliYun) GetAccessKeyId() string {
	if x != nil {
...
func (x *Data_AliYun) GetAccessKeySecret() string {
	if x != nil {
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\aali_yun\x18\x03 \x01(\v2\x17.kratos.api.Data.AliYunR\x06aliYun\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1aX\n" +
	"\x06AliYun\x12\"\n" +
	"\raccess_key_id\x18\x01 \x01(\tR\vaccessKeyId\x12*\n" +
	"\x11access_key_secret\x18\x02 \x01(\tR\x0faccessKeySecretB\x1cZ\x1adoctors/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Data_AliYun)(nil),         // 7: kratos.api.Data.AliYun
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.ali_yun:type_name -> kratos.api.Data.AliYun
