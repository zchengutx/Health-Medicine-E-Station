...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, greeterService, logger, serviceDrugService, serviceEstimateService)
	...
	httpServer := server.NewHTTPServer(confServer, greeterService, serviceUserService, logger, serviceDrugService, serviceEstimateService, serviceChatService)
