...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	serviceChatService := service.NewChatService(chatService, dataData, userService, doctorsService)
	httpServer := server.NewHTTPServer(confServer, serviceUserService, serviceDoctorsService, serviceDrugService, serviceEstimateService, serviceChatService, serviceCartService, orderService, couponService, prescriptionService, logger)
