...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	httpServer := server.NewHTTPServer(confServer, serviceDoctorsService, serviceDrugService, serviceEstimateService, serviceChatService, serviceUserService, logger)
