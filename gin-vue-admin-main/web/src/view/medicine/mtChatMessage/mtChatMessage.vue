  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="发送者id" prop="fromId" width="120" />

            <el-table-column align="left" label="接收者id" prop="toId" width="120" />

            <el-table-column align="left" label="消息内容" prop="content" width="120" />

            <el-table-column align="left" label="消息类型" prop="messageType" width="120">
    <template #default="scope">
    {{ filterDict(scope.row.messageType,message_typeOptions) }}
    </template>
</el-table-column>
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button v-auth="btnAuth.edit" type="primary" link icon="edit" class="table-button" @click="updateMtChatMessageFunc(scope.row)">编辑</el-button>
...
import {
  createMtChatMessage,
  deleteMtChatMessage,
  deleteMtChatMessageByIds,
  updateMtChatMessage,
  findMtChatMessage,
  getMtChatMessageList
...
const getTableData = async() => {
  const table = await getMtChatMessageList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const onDelete = async() => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    type: 'warning'
      ...
      const res = await deleteMtChatMessageByIds({ IDs })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
// 更新行
const updateMtChatMessageFunc = async(row) => {
    const res = await findMtChatMessage({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deleteMtChatMessageFunc = async (row) => {
    const res = await deleteMtChatMessage({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
