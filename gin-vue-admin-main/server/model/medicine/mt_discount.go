...
type MtDiscount struct {
  ...
  DiscountAmout  *float64 `json:"discountAmout" form:"discountAmout" gorm:"comment:优惠金额;column:discount_amout;size:10;" binding:"required"`  //优惠金额
  MinOrderAmount  *float64 `json:"minOrderAmount" form:"minOrderAmount" gorm:"comment:最低消费门槛;column:min_order_amount;size:10;" binding:"required"`  //最低消费门槛
  ...
  MaxIssue  *int `json:"maxIssue" form:"maxIssue" gorm:"comment:总发行量，0=不限;column:max_issue;size:10;" binding:"required"`  //总发行量，0=不限
