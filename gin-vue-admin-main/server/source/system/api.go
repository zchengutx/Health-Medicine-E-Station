...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		// 药品相关API
		{ApiGroup: "药品", Method: "POST", Path: "/mtDrug/createMtDrug", Description: "创建药品"},
		{ApiGroup: "药品", Method: "DELETE", Path: "/mtDrug/deleteMtDrug", Description: "删除药品"},
		{ApiGroup: "药品", Method: "DELETE", Path: "/mtDrug/deleteMtDrugByIds", Description: "批量删除药品"},
		{ApiGroup: "药品", Method: "PUT", Path: "/mtDrug/updateMtDrug", Description: "更新药品"},
		{ApiGroup: "药品", Method: "GET", Path: "/mtDrug/findMtDrug", Description: "根据ID获取药品"},
		{ApiGroup: "药品", Method: "GET", Path: "/mtDrug/getMtDrugList", Description: "获取药品列表"},

		{ApiGroup: "药品分类", Method: "POST", Path: "/mtDrugCategory/createMtDrugCategory", Description: "创建药品分类"},
		{ApiGroup: "药品分类", Method: "DELETE", Path: "/mtDrugCategory/deleteMtDrugCategory", Description: "删除药品分类"},
		{ApiGroup: "药品分类", Method: "DELETE", Path: "/mtDrugCategory/deleteMtDrugCategoryByIds", Description: "批量删除药品分类"},
		{ApiGroup: "药品分类", Method: "PUT", Path: "/mtDrugCategory/updateMtDrugCategory", Description: "更新药品分类"},
		{ApiGroup: "药品分类", Method: "GET", Path: "/mtDrugCategory/findMtDrugCategory", Description: "根据ID获取药品分类"},
		{ApiGroup: "药品分类", Method: "GET", Path: "/mtDrugCategory/getMtDrugCategoryList", Description: "获取药品分类列表"},
		{ApiGroup: "药品分类", Method: "GET", Path: "/mtDrugCategory/getAllMtDrugTypeStair", Description: "获取所有一级分类"},
		{ApiGroup: "药品分类", Method: "GET", Path: "/mtDrugCategory/getAllMtDrugTypeLevel", Description: "获取所有二级分类"},

		{ApiGroup: "一级分类", Method: "POST", Path: "/mtDrugTypeStair/createMtDrugTypeStair", Description: "创建一级分类"},
		{ApiGroup: "一级分类", Method: "DELETE", Path: "/mtDrugTypeStair/deleteMtDrugTypeStair", Description: "删除一级分类"},
		{ApiGroup: "一级分类", Method: "DELETE", Path: "/mtDrugTypeStair/deleteMtDrugTypeStairByIds", Description: "批量删除一级分类"},
		{ApiGroup: "一级分类", Method: "PUT", Path: "/mtDrugTypeStair/updateMtDrugTypeStair", Description: "更新一级分类"},
		{ApiGroup: "一级分类", Method: "GET", Path: "/mtDrugTypeStair/findMtDrugTypeStair", Description: "根据ID获取一级分类"},
		{ApiGroup: "一级分类", Method: "GET", Path: "/mtDrugTypeStair/getMtDrugTypeStairList", Description: "获取一级分类列表"},
		{ApiGroup: "一级分类", Method: "GET", Path: "/mtDrugTypeStair/getAllMtDrugTypeStair", Description: "获取所有一级分类"},

		{ApiGroup: "二级分类", Method: "POST", Path: "/mtDrugTypeLevel/createMtDrugTypeLevel", Description: "创建二级分类"},
		{ApiGroup: "二级分类", Method: "DELETE", Path: "/mtDrugTypeLevel/deleteMtDrugTypeLevel", Description: "删除二级分类"},
		{ApiGroup: "二级分类", Method: "DELETE", Path: "/mtDrugTypeLevel/deleteMtDrugTypeLevelByIds", Description: "批量删除二级分类"},
		{ApiGroup: "二级分类", Method: "PUT", Path: "/mtDrugTypeLevel/updateMtDrugTypeLevel", Description: "更新二级分类"},
		{ApiGroup: "二级分类", Method: "GET", Path: "/mtDrugTypeLevel/findMtDrugTypeLevel", Description: "根据ID获取二级分类"},
		{ApiGroup: "二级分类", Method: "GET", Path: "/mtDrugTypeLevel/getMtDrugTypeLevelList", Description: "获取二级分类列表"},
		{ApiGroup: "二级分类", Method: "GET", Path: "/mtDrugTypeLevel/getAllMtDrugTypeLevel", Description: "获取所有二级分类"},
	}
