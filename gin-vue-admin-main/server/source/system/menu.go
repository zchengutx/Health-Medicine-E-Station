...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	allMenus := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "medicine", Name: "medicine", Component: "view/routerHolder.vue", Sort: 10, Meta: Meta{Title: "药品管理", Icon: "medicine-box"}},
	}
	...
	childMenus := []SysBaseMenu{
		...
		// medicine子菜单
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["medicine"], Path: "medicineOverview", Name: "medicineOverview", Component: "view/medicine/overview.vue", Sort: 1, Meta: Meta{Title: "药品概览", Icon: "odometer"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["medicine"], Path: "mtDrug", Name: "mtDrug", Component: "view/medicine/mtDrug/mtDrug.vue", Sort: 2, Meta: Meta{Title: "药品列表", Icon: "list"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["medicine"], Path: "mtDrugCategory", Name: "mtDrugCategory", Component: "view/medicine/mtDrugCategory/mtDrugCategory.vue", Sort: 3, Meta: Meta{Title: "药品分类", Icon: "folder"}},
	}
