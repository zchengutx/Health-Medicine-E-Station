...
-- 1. 创建 mt_drug_type_stair 表
CREATE TABLE IF NOT EXISTS `mt_drug_type_stair` (
...
-- 2. 创建 mt_drug_type_level 表
CREATE TABLE IF NOT EXISTS `mt_drug_type_level` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `created_at` datetime(3) DEFAULT NULL,
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
...
-- 3. 创建 mt_drug_category 表
CREATE TABLE IF NOT EXISTS `mt_drug_category` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `created_at` datetime(3) DEFAULT NULL,
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
...
-- 4. 创建 mt_drug 表
CREATE TABLE IF NOT EXISTS `mt_drug` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `created_at` datetime(3) DEFAULT NULL,
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
...
-- 5. 创建 mt_doctors 表
CREATE TABLE IF NOT EXISTS `mt_doctors` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `created_at` datetime(3) DEFAULT NULL,
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
  ...
  `deleted_by` bigint unsigned DEFAULT NULL COMMENT '删除者',
  PRIMARY KEY (`id`),
  KEY `idx_mt_doctors_deleted_at` (`deleted_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 6. 创建 mt_orders_drug 表
CREATE TABLE IF NOT EXISTS `mt_orders_drug` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `created_at` datetime(3) DEFAULT NULL,
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
